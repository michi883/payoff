...
Design setup, escalation, turn, payoff, and response around the requested emotional journey. Adjacent beats must not repeat the same event. The final turn must be causally earned and visibly deliver the requested emotional landing.
